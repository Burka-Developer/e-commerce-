...
const categories = [
  ...
  { id: "gym wear", label: "Gym Wear", count: 80 },
  { id: "hoodies", label: "Hoodies", count: 70 },
  { id: "wedding clothes", label: "Wedding Clothes", count: 60 },
  { id: "abayas", label: "Abayas", count: 110 },
]
...
export function ProductFilters({ onFiltersChange }: ProductFiltersProps) {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm">{t("activeFilters")} ({activeFiltersCount})</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm">{t("categoriesLabel")}</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm">{t("brands")}</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          {brands.map((brand) => (
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm">{t("minRating")}</CardTitle>
        </CardHeader>
        <CardContent>
